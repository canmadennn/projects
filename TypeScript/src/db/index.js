...
const initOptions = {
    ...
    extend(obj, dc) {
        ...
        obj.test = new repos_1.TestRepository(obj, pgp);
        obj.genericSql = new repos_1.GenericSqlRepository(obj, pgp);
        obj.userOperations = new repos_1.UserOperationsRepository(obj, pgp);
    }
};
