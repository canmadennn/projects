sap.ui.define([
    ...
    var oLogger = Log.getLogger("sfcStartAndCompletePlugin", Log.Level.INFO);

    var oExampleExecutionPlugin = ProductionComponent.extend("com.maden.viewplugins.sfcStartAndComplete.Component", {
        metadata: {
            manifest: "json"
        },
        execute: function () {
